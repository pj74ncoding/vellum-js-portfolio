...
// const homePublicbOrPrivatebutton = document.getElementById(
...
// // cardSection.children[2].classList.add("")
// homePublicOrPrivate();
...
//       homePublicbOrPrivatebutton.innerHTML = "Change To Private Reflections";

//       homeStoredPublicVellum.slice(-6).forEach((vellum) => {
...
//       homePadlock.classList.add("fa-xl");
//       homePublicbOrPrivatebutton.innerHTML = "Change To Public Reflections";
//       cardSection.innerHTML = "";
//       homeStoredPrivateVellum.slice(-6).forEach((vellum) => {
//         const cardSectionDiv = document.createElement("div");
//         const cardSectionDateParagraph = document.createElement("p");
//         const cardSectionHeading = document.createElement("h2");
//         const reflectionParagraphDiv = document.createElement("div");
